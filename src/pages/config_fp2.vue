            ...
            <carousel-item>
              <div class="diplay-flex-column">
                ...
                <el-form inline size="medium" style="font-size:0" @submit.native.prevent>
                  ...
                  <el-form-item>
                    <el-button type="primary" @click="onAddRyList">确定</el-button>
                    <el-button type="danger" @click="onDeleteRy('all')">批量取消人员</el-button>
                  </el-form-item>
                </el-form>
                <div style="flex:1">
                  <el-table height="700px" border :data="getedRyData.rows" v-loading="getedRyData.loading" @select-all="onSelect_getedRyRows" @select="onSelect_getedRyRows">
                    <el-table-column type="selection" width="50px" align="center"></el-table-column>
    ...
    methods: {
        ...
        ajaxGetedRyList() {
            ...
            this.axios.post(
                ...
                data => {
                    ...
                    this.getedRyData.rows = data.rows || [];
        ...
        fn_edit(id) {
            ...
            this.axios.post(
                ...
                data => {
                    this.edit = data.res;
                    document.title = "分配：" + this.edit.xmmc;
                    this.gsgj.dataset = {
        ...
        onChangePLan(v) {
            let research = this.$router.resolve({
                path: `/configfp?jbxx_id=${this.jbxx_id}&thread_id=${v}`
            });
        ...
        changeYshData(data, newData) {
            ...
            // console.log(this[data.dataObj].zbMinNum)
