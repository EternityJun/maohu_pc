<template>
  <div class="bid_research">
    ...
    <el-row>
      <el-col :span="24">
        <audit-table
          v-loading="count_ajax >=2 ? false : true"
          @changeStateTrue="changeStateTrue"
          @changeStateFalse="changeStateFalse"
          v-on:changeYshData="changeYshData"
          v-on:fnAddCompanyToProject="fnAddCompanyToProject"
          v-on:auditNoAudit="ajaxOnYesorNoList"
          :yshData="yesGsData"
          :wshData="noGsData"
          :allData="allGsData"
          ...
          <carousel-card height="900px">
              ...
              <div class="diplay-flex-column">
                ...
                <el-form inline size="medium" style="font-size:0" @submit.native.prevent>
                  <el-form-item style="width:180px">
                    <el-input
                      clearable
                      @clear="onSearch('ajaxYesGetedGsList','yesGetedGsData')"
                      placeholder="公司名称"
                      v-model="yesGetedGsData.formData.gsmc"
                      @keydown.enter.native="onSearch('ajaxYesGetedGsList','yesGetedGsData')"
                    ></el-input>
                  </el-form-item>
                  <el-form-item style="width:110px">
                    <el-select
                      ...
                      @change="onChangeArea('ajaxYesGetedGsList','yesGetedGsData')"
                    >
                  ...
                  <el-form-item>
                    <el-button
                      type="primary"
                      @click="onSearch('ajaxYesGetedGsList','yesGetedGsData')"
                    >查询</el-button>
                  ...
                  <el-form-item style="width:110px">
                    <el-select
                      placeholder="选择人员"
                      v-model="yesGetedGsData.formData.ryVal"
                      @change="onDistribute_button('all','ajaxYesGetedGsList',yesGetedGsData.formData.ryVal,yesGetedGsData.selectRows,'audit_user_id','',yesGetedGsData.formData.fp_bs_sh)"
                    >
                      <el-option label value></el-option>
                      <el-option
                        v-for="item in allUsers[yesGetedGsData.formData.fp_bs_sh]"
                        :key="item.id"
                        :label="item.username"
                        :value="item.id"
                      ></el-option>
                  ...
                  <el-form-item style="margin-left:20px;">
                    ...
                    <el-select
                      ...
                      v-model="open_close"
                      placeholder="开通或关闭展示"
                      @change="onIsDisplay('','ajaxYesGetedGsList',yesGetedGsData.selectRows)"
                    >
                  ...
                  <el-form-item style="position:absolute;right:0px;">
                    <el-button
                      type="danger"
                      @click="onDeleteGs('all','ajaxYesGetedGsList','yesGetedGsData')"
                    >批量删除</el-button>
                  </el-form-item>
                </el-form>
                <div style="flex:1">
                  ...
                  >
                    ...
                    <el-table-column type="index" width="50px" label="序号" align="center">
                      <template
                        slot-scope="scope"
                      >{{scope.$index+(yesGetedGsData.page-1)*yesGetedGsData.row+1}}</template>
                    </el-table-column>
                      ...
                      <template slot-scope="scope">
                        <div style="display:flex">
                          ...
                          <div style="padding-left:2px">
                            <i
                              v-if="scope.row.take_sign==1 || scope.row.take_sign==2"
                              style="color:#54e20d"
                              class="el-icon-check"
                            ></i>
                            <i
                              v-if="scope.row.take_sign==2"
                              style="color:#54e20d"
                              class="el-icon-check"
                            ></i>
                          </div>
                    ...
                    <el-table-column prop="human_user" width="90px" label="审核人员" align="center">
                      <template slot-scope="scope">
                        <change-ry
                          :ry_list="allUsers"
                          :extraObj="{type:'人工审核',ajaxFn:'ajaxYesGetedGsList',dataObj:'yesGetedGsData',ry_type:'human_user_id'}"
                          :row="scope.row"
                          :ry="scope.row.human_user"
                    ...
                    <el-table-column prop="audit_user" width="100px" label="拿公司人员" align="center">
                      <template slot-scope="scope">
                        <change-ry
                          :ry_list="allUsers"
                          :extraObj="{type:'分配',ajaxFn:'ajaxYesGetedGsList',dataObj:'yesGetedGsData',ry_type:'audit_user_id'}"
                          :row="scope.row"
                    ...
                    <el-table-column prop="tender_user" width="110px" label="制作标书人员" align="center">
                      <template slot-scope="scope">
                        <change-ry
                          :ry_list="allUsers"
                          :extraObj="{type:'标书制作',ajaxFn:'ajaxYesGetedGsList',dataObj:'yesGetedGsData',ry_type:'tender_user_id'}"
                          :row="scope.row"
                          :ry="scope.row.tender_user"
                          @onSelect="onListInSelect"
                        ></change-ry>
                      </template>
                    </el-table-column>
                    <el-table-column prop label="认识的人" width="100px" align="center">
                      <template slot-scope="scope">
                        <div v-if="scope.row.firm.length > 0">
                          <change-ry
                            :ry_list="{'认识的人':computeKnow(scope.row.firm)}"
                            :extraObj="{type:'认识的人',ajaxFn:'ajaxYesGetedGsList',dataObj:'yesGetedGsData',ry_type:'audit_user_id'}"
                            :row="scope.row"
                            ry="选择"
                            @onSelect="onListInSelect"
                          ></change-ry>
                ...
                <el-pagination
                  ...
                  :current-page.sync="yesGetedGsData.page"
            ...
            <carousel-item>
              <div class="diplay-flex-column">
                ...
                <el-form inline size="medium" style="font-size:0" @submit.native.prevent>
                  <el-form-item :label="'添加'+this.user_cate+'人员'">
                    <el-select placeholder="选择" v-model="getedRyData.formData.ryVal">
                      <el-option
                        v-for="item in allUsers[user_cate]"
                        :key="item.id"
                        :label="item.username"
                        :value="item.id"
                      ></el-option>
                ...
                <div style="flex:1">
                  ...
                  >
                    ...
                    <el-table-column type="index" width="60" label="序号" align="center">
                      <template
                        slot-scope="scope"
                      >{{scope.$index+(getedRyData.page-1)*getedRyData.row+1}}</template>
                    </el-table-column>
                    <el-table-column prop="username" label="人员" align="center"></el-table-column>
                    <el-table-column prop="bs_check" label="标书制作" align="center">
                      <template slot-scope="scope">
                        <el-button
                          v-if="scope.row.bs_check == 1"
                          size="mini"
                          type="success"
                          icon="el-icon-check"
                          circle
                          @click="onRySwitch(scope.row,'no',scope.row.bs_check_group_id)"
                        ></el-button>
                        <el-button
                          v-else
                          size="mini"
                          ...
                          icon="el-icon-close"
                          circle
                          @click="onRySwitch(scope.row,'yes',scope.row.bs_check_group_id)"
                        ></el-button>
                      </template>
                    </el-table-column>
                    <el-table-column label="所负责公司" align="center">
                      <template slot-scope="scope">
                        <el-button
                          :type="scope.row.hasCompany==1 ? 'primary' : ''"
                          size="mini"
                          @click="onGetUserGsList(scope.row)"
                        >查看</el-button>
                      </template>
                    </el-table-column>
                ...
                <el-pagination
                  style="margin-top:20px"
                  :current-page.sync="getedRyData.page"
              ...
              <div class="diplay-flex-column">
                ...
                <el-form inline size="medium" style="font-size:0" @submit.native.prevent>
                  <el-form-item style="width:180px">
                    <el-input
                      clearable
                      @clear="onSearch('ajaxNoGetedGsList','noGetedGsData')"
                      placeholder="公司名称"
                      v-model="noGetedGsData.formData.gsmc"
                      @keydown.enter.native="onSearch('ajaxNoGetedGsList','noGetedGsData')"
                    ></el-input>
                  </el-form-item>
                  <el-form-item style="width:110px">
                    <el-select
                      placeholder="不限制"
                      v-model="noGetedGsData.formData.areaTypeVal"
                      @change="onChangeArea('ajaxNoGetedGsList','noGetedGsData')"
                    >
                      <el-option label="不限制" value="0"></el-option>
                      <el-option label="川内企业" value="1"></el-option>
                      <el-option label="入川企业" value="2"></el-option>
                  ...
                  <el-form-item>
                    <el-button
                      type="primary"
                      @click="onSearch('ajaxNoGetedGsList','noGetedGsData')"
                    >查询</el-button>
                    <el-button @click="onResetForm('ajaxNoGetedGsList','noGetedGsData')">重置</el-button>
                  </el-form-item>
                  <el-form-item style="width:120px;margin-left:20px;">
                  ...
                  <el-form-item style="width:110px">
                    <el-select
                      placeholder="选择人员"
                      v-model="noGetedGsData.formData.ryVal"
                      @change="onDistribute_button('all','ajaxNoGetedGsList',noGetedGsData.formData.ryVal,noGetedGsData.selectRows,'audit_user_id','',noGetedGsData.formData.fp_bs_sh)"
                    >
                      <el-option label value></el-option>
                      <el-option
                        v-for="item in allUsers[noGetedGsData.formData.fp_bs_sh]"
                        :key="item.id"
                        :label="item.username"
                        :value="item.id"
                      ></el-option>
                  ...
                  <el-form-item style="margin-left:20px;">
                    <el-select
                      ...
                      filterable
                      placeholder="方案"
                      v-model="noGetedGsData.formData.planVal"
                    >
                      <el-option label value></el-option>
                      <el-option
                        v-for="item in planList"
                    ...
                    <el-button
                      type="primary"
                      @click="onExecutePlan('noGetedGsData','ajaxNoGetedGsList',noGetedGsData.formData.planVal)"
                    >执行方案</el-button>
                    <el-button type="success" @click="set_newPlan('tj')">添加验证</el-button>
                    <el-select
                      style="width:150px;margin-left:20px;"
                      v-model="open_close"
                      placeholder="开通或关闭展示"
                      @change="onIsDisplay('','ajaxNoGetedGsList',noGetedGsData.selectRows)"
                    >
                      <el-option label="开通展示" value="yes"></el-option>
                      <el-option label="取消开通" value="no"></el-option>
                    </el-select>
                  ...
                  <el-form-item style="position:absolute;right:0px;">
                    <el-button
                      type="danger"
                      @click="onDeleteGs('all','ajaxNoGetedGsList','noGetedGsData')"
                    >批量删除</el-button>
                  </el-form-item>
                </el-form>
                <div style="flex:1">
                  <el-table
                    height="700px"
                    border
                    :data="noGetedGsData.rows"
                    v-loading="noGetedGsData.loading"
                    @select-all="onSelect_noGetedGsRows"
                    @select="onSelect_noGetedGsRows"
                  >
                    <el-table-column type="selection" width="50px" align="center"></el-table-column>
                    ...
                    <el-table-column type="index" width="50px" label="序号" align="center">
                      <template
                        slot-scope="scope"
                      >{{scope.$index+(noGetedGsData.page-1)*noGetedGsData.row+1}}</template>
                    </el-table-column>
                    <el-table-column prop="gsmc" label="公司名称" align="center">
                      <template slot-scope="scope">
                        <div class="link_text" @click="openGs(scope.row)">{{scope.row.gsmc}}</div>
                    ...
                    <el-table-column prop="human_user" label="审核人员" align="center">
                      <template slot-scope="scope">
                        <change-ry
                          :ry_list="allUsers"
                          :extraObj="{type:'人工审核',ajaxFn:'ajaxNoGetedGsList',dataObj:'noGetedGsData',ry_type:'human_user_id'}"
                          :row="scope.row"
                          :ry="scope.row.human_user"
                          @onSelect="onListInSelect"
                        ></change-ry>
                    ...
                    <el-table-column prop="tender_user" label="制作标书人员" align="center">
                      <template slot-scope="scope">
                        <change-ry
                          :ry_list="allUsers"
                          :extraObj="{type:'标书制作',ajaxFn:'ajaxNoGetedGsList',dataObj:'noGetedGsData',ry_type:'tender_user_id'}"
                          :row="scope.row"
                          :ry="scope.row.tender_user"
                          @onSelect="onListInSelect"
                        ></change-ry>
                    ...
                    <el-table-column prop label="认识的人" align="center" width="100">
                      <template slot-scope="scope">
                        <div v-if="scope.row.firm.length > 0">
                          <change-ry
                            :ry_list="{'认识的人':computeKnow(scope.row.firm)}"
                            :extraObj="{type:'认识的人',ajaxFn:'ajaxNoGetedGsList',dataObj:'noGetedGsData',ry_type:'audit_user_id'}"
                            :row="scope.row"
                            ry="选择"
                            @onSelect="onListInSelect"
                          ></change-ry>
                    ...
                    <el-table-column prop="display" label="是否已开通展示" align="center">
                      <template slot-scope="scope">
                        <el-button
                          ...
                          icon="el-icon-check"
                          circle
                          @click="onIsDisplay('no','ajaxNoGetedGsList',[scope.row],'one')"
                        ></el-button>
                        <el-button
                          v-else
                          size="mini"
                          ...
                          icon="el-icon-close"
                          circle
                          @click="onIsDisplay('yes','ajaxNoGetedGsList',[scope.row],'one')"
                        ></el-button>
                      </template>
                    </el-table-column>
                    <el-table-column label="操作" align="center">
                      <template slot-scope="scope">
                        <el-button
                          size="mini"
                          type="danger"
                          @click="onDeleteGs('one','ajaxNoGetedGsList',scope.row.gs_id)"
                        >删除</el-button>
                      </template>
                    </el-table-column>
                  </el-table>
                ...
                <el-pagination
                  style="margin-top:20px"
                  :current-page.sync="noGetedGsData.page"
                  @current-change="noGetedGsChangePage"
                  @size-change="noGetedGsChangeSize"
                  align="right"
                  background
                  layout="sizes,total,prev, pager, next"
                  :total="noGetedGsData.total"
                ></el-pagination>
              </div>
            </carousel-item>
          </carousel-card>
    ...
    <div v-if="research_plan.dialogVisible">
      <el-dialog title="新建方案" :visible.sync="research_plan.dialogVisible" width="50%">
        <bid-new-plan
          ...
          v-on:onSubmitNewPlan="onSubmitNewPlan"
          :data="{jbxx_id:research_plan.id,name:research_plan.name,tab:'bidResearch'}"
        ></bid-new-plan>
      </el-dialog>
    </div>
    ...
    <el-dialog title="负责公司" :visible.sync="userGslist.dialogVisible" top="50px">
      ...
      <el-pagination
        align="right"
        @current-change="changePageUserGsList"
        :current-page.sync="userGslist.page"
        background
        layout="total,prev, pager, next"
        :total="userGslist.total"
        class="pagination"
      ></el-pagination>
    </el-dialog>
  </div>
  ...
  methods: {
    ...
    fn_edit (id) {
      ...
      this.axios.post(
        ...
        data => {
          this.edit = data.res
          document.title = '标书：' + this.edit.xmmc
          this.gsgj.dataset = {
    ...
    onChangePLan (v) {
      let research = this.$router.resolve({
        path: `/configbs?jbxx_id=${this.jbxx_id}&thread_id=${v}`
      })
    ...
    changeYshData (data, newData) {
      ...
      // 组件操作
      this.operationState = true
      this[data.dataObj].tableNewData = newData || this[data.dataObj].tableNewData
