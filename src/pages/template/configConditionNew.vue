  ...
  <div>
    <el-form :model="form" style="padding:20px 40px" @submit.native.prevent>
          ...
          <div class="tiaojian-content">
            ...
            <el-form>
              <el-form-item label="业绩来源" label-width="68px">
                <el-checkbox v-model="form.lsyj.checkAll" @change="onCheckAllChange">全选</el-checkbox>
                <el-checkbox v-model="waterForm.checkWater" @change="onCheckWaterChange">水利</el-checkbox>
              ...
              <el-form inline style="padding-left:26px" :model="form.lsyj.ajax_data" :rules="rules" @submit.native.prevent>
                <el-form-item>
                  <el-popover placement="bottom" trigger="click">
                    <el-tree ref="treekgwg" @check="onSelect_kgwg" :default-checked-keys="form.lsyj.ajax_data.kgwg.split(',')" :data="kgwg_select" show-checkbox node-key="value" :check-on-click-node="true"></el-tree>
            ...
            <div v-show="waterForm.checkWater">
              ...
              <el-form ref="waterForm" :model="waterForm" label-width="100px">
                <el-row>
      ...
      <div style="text-align:center;">
        <el-button type="primary" @click="onConfirm('save')" v-loading.fullscreen.lock="fullscreenLoading">保存</el-button>
        <template v-if="visit_type">
          <el-button type="primary" @click="onConfirm('run')" v-loading.fullscreen.lock="fullscreenLoading">运行</el-button>
          <el-button type="primary" v-if="checkGsList" @click="onCheck">查看公司列表</el-button>
          <el-button type="primary" @click="onDefaultThread">
            默认方案
...
export default {
    ...
    created() {
        ...
        this.thread_id = this.parentThreadId || "";
        //获取资质类型
        this.axios.post(
    ...
    methods: {
                ...
                data => {
                    if (data.status == "success") {
                        ...
                        if (dataall.xmjl) {
                            ...
                            console.log(dataall.xmjl, "xiangmu");
                        }
                        // 技术负责人
                        if (dataall.jsfzr) {
        ...
        // 选择业绩来源
        onCheckOneChange(v) {
            console.log(this.form.lsyj.yjlyOptions, "vv");
            console.log(v, "v");
        ...
        onCheckAllChange() {
            this.form.lsyj.ajax_data.checkedList = this.form.lsyj.checkAll
                ...
                : [];
            console.log(this.form.lsyj.ajax_data.checkedList, "全选");
            this.waterForm.checkWater = false;
        },
        // 勾选水利
        onCheckWaterChange() {
